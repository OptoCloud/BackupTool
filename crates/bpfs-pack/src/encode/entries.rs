...
pub fn write_blob_entry<W: Write>(w: &mut W, e: &BlobEntry) -> io::Result<()> {
    w.write_u64_le(e.raw_size)?;
    w.write_u32_le(e.generation_idx)?;
    w.write_u32_le(e.section_idx)?;
    w.write_u32_le(e.section_blob_idx)?;
    Ok(())
}
...
pub fn write_directory_entry<W: Write>(w: &mut W, e: &DirectoryEntry) -> io::Result<()> {
    w.write_u32_le(e.parent_id)?;
    w.write_u32_le(e.name_stridx)?;
    w.write_u64_le(e.created_at)?;
    w.write_u64_le(e.modified_at)?;
    Ok(())
}
...
pub fn write_file_entry<W: Write>(w: &mut W, e: &FileEntry) -> io::Result<()> {
    w.write_u32_le(e.blob_idx)?;
    w.write_u32_le(e.dir_idx)?;
    w.write_u32_le(e.name_stridx)?;
    w.write_u64_le(e.created_at)?;
    w.write_u64_le(e.modified_at)?;
    Ok(())
